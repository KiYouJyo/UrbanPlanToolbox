...
public sealed class FakeAppUpdateService(FakeAppUpdateScenario scenario = FakeAppUpdateScenario.UpToDate) : IAppUpdateService
{
    ...
    public Task<AppUpdateInfo> CheckForUpdatesAsync(CancellationToken cancellationToken = default) => Task.FromResult(_scenario switch
    {
        ...
        FakeAppUpdateScenario.UpdateAvailable or FakeAppUpdateScenario.Cancelled or FakeAppUpdateScenario.DownloadFailed or FakeAppUpdateScenario.InstallFailed or FakeAppUpdateScenario.InstallWillCloseApp => new AppUpdateInfo(AppUpdateState.UpdateAvailable, AppVersionProvider.Version),
