...
public sealed class LocalizationService : ILocalizationService
{
    ...
    {
        ["zh-CN"] = new Dictionary<string, string> { ["Action_RestartAndUpdate"] = "重启并更新", ["Update_State_ReadyToInstall"] = "更新已下载，可以重启并完成更新", ["Update_State_RestartRequired"] = "更新已安装，重启后完成更新" },
        ["en-US"] = new Dictionary<string, string> { ["Action_RestartAndUpdate"] = "Restart and update", ["Update_State_ReadyToInstall"] = "Update downloaded. Restart and update when you are ready.", ["Update_State_RestartRequired"] = "The update is installed. Restart to complete the update." },
        ["ja-JP"] = new Dictionary<string, string> { ["Action_RestartAndUpdate"] = "再起動して更新", ["Update_State_ReadyToInstall"] = "更新をダウンロードしました。準備ができたら再起動して更新できます。", ["Update_State_RestartRequired"] = "更新はインストール済みです。再起動すると更新が完了します" }
    };
