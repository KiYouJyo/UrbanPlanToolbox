...
public sealed class ToolRegistry
{
    ...
    [
        ...
        new(
            ToolIds.DesignInspiration,
            "Tool_DesignInspiration_Name",
            "Tool_DesignInspiration_Description",
            ToolPrimaryCategory.Design,
            ToolSecondaryCategory.PreliminaryAnalysis,
            "\uE8A4",
            typeof(Views.InspirationManagementPage),
            85,
            true,
            "shejilinggan",
            "S",
            "Tool_DesignInspiration_Keywords"),
        new(
            ToolIds.ResearchInspiration,
            "Tool_ResearchInspiration_Name",
            "Tool_ResearchInspiration_Description",
            ToolPrimaryCategory.Research,
            ...
            "keyanlinggan",
            "K",
            "Tool_ResearchInspiration_Keywords"),
        new(
