...
public sealed partial class LocalizationTests
{
    ...
    public void VersionConfigurationIs110AndChannelsRemainDistinct()
    {
        ...
        Assert.Contains("Version=\"1.5.2.1\"", manifest);
        ...
        Assert.Contains("<Version>1.5.2.1</Version>", project);
        Assert.Contains("<AssemblyVersion>1.5.2.1</AssemblyVersion>", project);
        Assert.Contains("<FileVersion>1.5.2.1</FileVersion>", project);
        Assert.Contains("<InformationalVersion>1.5.2.1</InformationalVersion>", project);
        ...
        Assert.Contains("Version=\"1.5.2.1\"", storeManifest);
