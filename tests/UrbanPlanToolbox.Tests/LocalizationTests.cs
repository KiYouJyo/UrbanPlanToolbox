...
public sealed partial class LocalizationTests
{
    ...
    public void SearchResultsReturnSameStableToolIdsAcrossLanguages()
    {
        ...
        Assert.Equal([ToolIds.UnitScaleConverter, ToolIds.DesignConceptDictionary, ToolIds.PlanningIndicatorCalculator, ToolIds.WorkflowReviewChecklist, ToolIds.PlanningTerminology, ToolIds.ColorPaletteRecorder, ToolIds.FieldSurveyPhotoGis, ToolIds.RegulationsIndex, ToolIds.CoordinateSystemConverter], ids);
        }
    }
    ...
    public void VersionConfigurationIs110AndChannelsRemainDistinct()
    {
        ...
        Assert.Contains("Version=\"1.4.3.0\"", manifest);
        ...
        Assert.Contains("<Version>1.4.3</Version>", project);
        Assert.Contains("<AssemblyVersion>1.4.3</AssemblyVersion>", project);
        Assert.Contains("<FileVersion>1.4.3</FileVersion>", project);
        Assert.Contains("<InformationalVersion>1.4.3</InformationalVersion>", project);
        ...
        Assert.Contains("Version=\"1.4.3.0\"", storeManifest);
