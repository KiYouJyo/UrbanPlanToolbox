...
public sealed partial class LocalizationTests
{
    ...
    public void VersionConfigurationIs110AndChannelsRemainDistinct()
    {
        ...
        Assert.Contains("Version=\"1.3.1.0\"", manifest);
        ...
        Assert.Contains("<AssemblyVersion>1.3.1</AssemblyVersion>", project);
        Assert.Contains("<FileVersion>1.3.1</FileVersion>", project);
        Assert.Contains("<InformationalVersion>1.3.1</InformationalVersion>", project);
