...
public sealed partial class LocalizationTests
{
    ...
    public void VersionConfigurationIs110AndChannelsRemainDistinct()
    {
        ...
        Assert.Contains("Version=\"1.6.0.0\"", manifest);
        ...
        Assert.Contains("<Version>1.6.0</Version>", project);
        Assert.Contains("<AssemblyVersion>1.6.0</AssemblyVersion>", project);
        Assert.Contains("<FileVersion>1.6.0</FileVersion>", project);
        Assert.Contains("<InformationalVersion>1.6.0</InformationalVersion>", project);
        ...
        Assert.Contains("Version=\"1.6.0.0\"", storeManifest);
