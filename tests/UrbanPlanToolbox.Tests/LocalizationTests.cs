...
public sealed partial class LocalizationTests
{
    ...
    public void VersionConfigurationIs110AndChannelsRemainDistinct()
    {
        ...
        Assert.Contains("Version=\"1.5.3.0\"", manifest);
        ...
        Assert.Contains("<Version>1.5.3</Version>", project);
        Assert.Contains("<AssemblyVersion>1.5.3</AssemblyVersion>", project);
        Assert.Contains("<FileVersion>1.5.3</FileVersion>", project);
        Assert.Contains("<InformationalVersion>1.5.3</InformationalVersion>", project);
        ...
        Assert.Contains("Version=\"1.5.3.0\"", storeManifest);
