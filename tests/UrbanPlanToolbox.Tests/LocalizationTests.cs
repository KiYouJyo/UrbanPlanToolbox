...
public sealed partial class LocalizationTests
{
    ...
    public void VersionConfigurationIs168AndChannelsRemainDistinct()
    {
        ...
        Assert.Contains("Version=\"1.6.9.0\"", manifest);
        ...
        Assert.Contains("<Version>1.6.9</Version>", project);
        Assert.Contains("<AssemblyVersion>1.6.9.0</AssemblyVersion>", project);
        Assert.Contains("<FileVersion>1.6.9.0</FileVersion>", project);
        Assert.Contains("<InformationalVersion>1.6.9</InformationalVersion>", project);
        ...
        Assert.Contains("Version=\"1.6.9.0\"", storeManifest);
