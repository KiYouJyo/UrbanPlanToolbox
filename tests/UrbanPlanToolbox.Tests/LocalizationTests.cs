...
public sealed partial class LocalizationTests
{
    ...
    public void VersionConfigurationIs050()
    {
        ...
        Assert.Contains("Version=\"0.5.0.1\"", manifest);
        ...
        Assert.Contains("<AssemblyVersion>0.5.0</AssemblyVersion>", project);
        Assert.Contains("<FileVersion>0.5.0</FileVersion>", project);
