...
public sealed partial class LocalizationTests
{
    ...
    public void VersionConfigurationIs110AndChannelsRemainDistinct()
    {
        ...
        Assert.Contains("Version=\"1.5.8.0\"", manifest);
        ...
        Assert.Contains("<Version>1.5.8</Version>", project);
        Assert.Contains("<AssemblyVersion>1.5.8</AssemblyVersion>", project);
        Assert.Contains("<FileVersion>1.5.8</FileVersion>", project);
        Assert.Contains("<InformationalVersion>1.5.8</InformationalVersion>", project);
        ...
        Assert.Contains("Version=\"1.5.8.0\"", storeManifest);
