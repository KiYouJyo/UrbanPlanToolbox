...
public sealed partial class LocalizationTests
{
    ...
    public void VersionConfigurationIs168AndChannelsRemainDistinct()
    {
        ...
        Assert.Contains("Version=\"1.7.3.0\"", manifest);
        ...
        Assert.Contains("<Version>1.7.3</Version>", project);
        Assert.Contains("<AssemblyVersion>1.7.3.0</AssemblyVersion>", project);
        Assert.Contains("<FileVersion>1.7.3.0</FileVersion>", project);
        Assert.Contains("<InformationalVersion>1.7.3</InformationalVersion>", project);
        ...
        Assert.Contains("Version=\"1.7.3.0\"", storeManifest);
