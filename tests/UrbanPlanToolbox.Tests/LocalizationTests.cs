...
public sealed partial class LocalizationTests
{
    ...
    public void SearchResultsReturnSameStableToolIdsAcrossLanguages()
    {
        ...
        Assert.Equal([ToolIds.UnitScaleConverter, ToolIds.DesignConceptDictionary, ToolIds.PlanningIndicatorCalculator, ToolIds.WorkflowReviewChecklist, ToolIds.PlanningTerminology, ToolIds.ColorPaletteRecorder, ToolIds.FieldSurveyPhotoGis, ToolIds.DrawingVersionComparator, ToolIds.RegulationsIndex, ToolIds.CoordinateSystemConverter], ids);
        }
    }
    ...
    public void VersionConfigurationIs110AndChannelsRemainDistinct()
    {
        ...
        Assert.Contains("Version=\"1.5.0.0\"", manifest);
        ...
        Assert.Contains("<Version>1.5.0</Version>", project);
        Assert.Contains("<AssemblyVersion>1.5.0</AssemblyVersion>", project);
        Assert.Contains("<FileVersion>1.5.0</FileVersion>", project);
        Assert.Contains("<InformationalVersion>1.5.0</InformationalVersion>", project);
        ...
        Assert.Contains("Version=\"1.5.0.0\"", storeManifest);
