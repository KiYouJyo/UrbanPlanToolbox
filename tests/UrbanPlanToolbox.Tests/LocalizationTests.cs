...
public sealed partial class LocalizationTests
{
    ...
    [Fact]
    public void VersionConfigurationIs167AndChannelsRemainDistinct()
    {
        ...
        Assert.Contains("<Version>1.6.7</Version>", project);
        Assert.Contains("<AssemblyVersion>1.6.7</AssemblyVersion>", project);
        Assert.Contains("<FileVersion>1.6.7</FileVersion>", project);
        Assert.Contains("<InformationalVersion>1.6.7</InformationalVersion>", project);
        ...
        Assert.Contains("Version=\"1.6.7.0\"", storeManifest);
