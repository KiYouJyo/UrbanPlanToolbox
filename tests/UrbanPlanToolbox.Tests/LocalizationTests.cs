...
public sealed partial class LocalizationTests
{
    ...
    public void VersionConfigurationIs110AndChannelsRemainDistinct()
    {
        ...
        Assert.Contains("Version=\"1.5.6.0\"", manifest);
        ...
        Assert.Contains("<Version>1.5.6</Version>", project);
        Assert.Contains("<AssemblyVersion>1.5.6</AssemblyVersion>", project);
        Assert.Contains("<FileVersion>1.5.6</FileVersion>", project);
        Assert.Contains("<InformationalVersion>1.5.6</InformationalVersion>", project);
        ...
        Assert.Contains("Version=\"1.5.6.0\"", storeManifest);
