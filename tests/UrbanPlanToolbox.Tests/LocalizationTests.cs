...
public sealed partial class LocalizationTests
{
    ...
    public void VersionConfigurationIs110AndChannelsRemainDistinct()
    {
        ...
        Assert.Contains("Version=\"1.3.0.0\"", manifest);
        ...
        Assert.Contains("<AssemblyVersion>1.3.0</AssemblyVersion>", project);
        Assert.Contains("<FileVersion>1.3.0</FileVersion>", project);
