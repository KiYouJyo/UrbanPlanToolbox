...
public sealed partial class LocalizationTests
{
    ...
    public void VersionConfigurationIs168AndChannelsRemainDistinct()
    {
        ...
        Assert.Contains("<Version>1.6.8</Version>", project);
        Assert.Contains("<AssemblyVersion>1.6.8.0</AssemblyVersion>", project);
        Assert.Contains("<FileVersion>1.6.8.0</FileVersion>", project);
        Assert.Contains("<InformationalVersion>1.6.8</InformationalVersion>", project);
        ...
        Assert.Contains("Version=\"1.6.8.0\"", storeManifest);
