...
public sealed partial class LocalizationTests
{
    ...
    public void VersionConfigurationIs110AndChannelsRemainDistinct()
    {
        ...
        Assert.Contains("Version=\"1.5.2.0\"", manifest);
        ...
        Assert.Contains("<Version>1.5.2</Version>", project);
        Assert.Contains("<AssemblyVersion>1.5.2</AssemblyVersion>", project);
        Assert.Contains("<FileVersion>1.5.2</FileVersion>", project);
        Assert.Contains("<InformationalVersion>1.5.2</InformationalVersion>", project);
        ...
        Assert.Contains("Version=\"1.5.2.0\"", storeManifest);
