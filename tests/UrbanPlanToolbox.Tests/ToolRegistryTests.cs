...
public sealed class ToolRegistryTests
{
    ...
    {
        Assert.Equal(5, ToolRegistry.Default.GetByPrimaryCategory(ToolPrimaryCategory.Design).Count);
        ...
        Assert.Equal(
            [ToolIds.PlanningIndicatorCalculator, ToolIds.UnitScaleConverter, ToolIds.ColorPaletteRecorder, ToolIds.WorkflowReviewChecklist, ToolIds.RegulationsIndex],
