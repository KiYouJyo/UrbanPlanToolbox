...
public sealed class GitHubUpdateServiceTests
{
    ...
    {
        Assert.Equal("1.6.8", AppVersionProvider.Version);
        Assert.Equal("v1.6.8", AppVersionProvider.DisplayVersion);
    ...
    public async Task SendsCurrentApplicationUserAgent()
    {
        ...
        Assert.Equal("UrbanPlanToolbox/1.6.8", handler.UserAgent);
    }
