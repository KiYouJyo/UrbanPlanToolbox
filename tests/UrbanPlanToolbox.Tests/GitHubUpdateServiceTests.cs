...
public sealed class GitHubUpdateServiceTests
{
    ...
    {
        Assert.Equal("1.6.9", AppVersionProvider.Version);
        Assert.Equal("v1.6.9", AppVersionProvider.DisplayVersion);
    ...
    public async Task SendsCurrentApplicationUserAgent()
    {
        ...
        Assert.Equal("UrbanPlanToolbox/1.6.9", handler.UserAgent);
    }
