...
public sealed class GitHubUpdateServiceTests
{
    ...
    {
        Assert.Equal("1.2.0", AppVersionProvider.Version);
        Assert.Equal("v1.2.0", AppVersionProvider.DisplayVersion);
    ...
    public async Task SendsCurrentApplicationUserAgent()
    {
        ...
        Assert.Equal("UrbanPlanToolbox/1.2.0", handler.UserAgent);
    }
