...
public sealed class GitHubUpdateServiceTests
{
    ...
    {
        Assert.Equal("1.7.3", AppVersionProvider.Version);
        Assert.Equal("v1.7.3", AppVersionProvider.DisplayVersion);
    ...
    public async Task SendsCurrentApplicationUserAgent()
    {
        ...
        Assert.Equal("UrbanPlanToolbox/1.7.3", handler.UserAgent);
    }
