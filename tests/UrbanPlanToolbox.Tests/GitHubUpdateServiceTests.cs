...
public sealed class GitHubUpdateServiceTests
{
    ...
    {
        Assert.Equal("1.7.2", AppVersionProvider.Version);
        Assert.Equal("v1.7.2", AppVersionProvider.DisplayVersion);
    ...
    public async Task SendsCurrentApplicationUserAgent()
    {
        ...
        Assert.Equal("UrbanPlanToolbox/1.7.2", handler.UserAgent);
    }
