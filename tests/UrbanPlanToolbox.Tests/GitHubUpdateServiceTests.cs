...
public sealed class GitHubUpdateServiceTests
{
    ...
    {
        Assert.Equal("1.7.4", AppVersionProvider.Version);
        Assert.Equal("v1.7.4", AppVersionProvider.DisplayVersion);
    ...
    public async Task SendsCurrentApplicationUserAgent()
    {
        ...
        Assert.Equal("UrbanPlanToolbox/1.7.4", handler.UserAgent);
    }
