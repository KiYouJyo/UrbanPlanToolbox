...
public sealed class GitHubUpdateServiceTests
{
    ...
    {
        Assert.Equal("1.3.1", AppVersionProvider.Version);
        Assert.Equal("v1.3.1", AppVersionProvider.DisplayVersion);
    ...
    public async Task SendsCurrentApplicationUserAgent()
    {
        ...
        Assert.Equal("UrbanPlanToolbox/1.3.1", handler.UserAgent);
    }
