...
public sealed class GitHubUpdateServiceTests
{
    ...
    {
        Assert.Equal("1.5.5", AppVersionProvider.Version);
        Assert.Equal("v1.5.5", AppVersionProvider.DisplayVersion);
    ...
    public async Task SendsCurrentApplicationUserAgent()
    {
        ...
        Assert.Equal("UrbanPlanToolbox/1.5.5", handler.UserAgent);
    }
