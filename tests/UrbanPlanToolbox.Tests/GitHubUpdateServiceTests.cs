...
public sealed class GitHubUpdateServiceTests
{
    ...
    {
        Assert.False(string.IsNullOrWhiteSpace(AppVersionProvider.Version));
        Assert.Equal($"v{AppVersionProvider.Version}", AppVersionProvider.DisplayVersion);
    ...
    public async Task SendsCurrentApplicationUserAgent()
    {
        ...
        Assert.Equal($"UrbanPlanToolbox/{AppVersionProvider.Version}", handler.UserAgent);
    }
