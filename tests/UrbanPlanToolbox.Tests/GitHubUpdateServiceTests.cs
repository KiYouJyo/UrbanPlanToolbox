...
public sealed class GitHubUpdateServiceTests
{
    ...
    {
        Assert.Equal("1.5.4", AppVersionProvider.Version);
        Assert.Equal("v1.5.4", AppVersionProvider.DisplayVersion);
    ...
    public async Task SendsCurrentApplicationUserAgent()
    {
        ...
        Assert.Equal("UrbanPlanToolbox/1.5.4", handler.UserAgent);
    }
