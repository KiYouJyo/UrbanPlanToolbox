English | [简体中文](RELEASE-NOTES-v1.6.8.md) | [日本語](RELEASE-NOTES-v1.6.8.ja.md)

# UrbanPlanToolbox v1.6.8 maintenance closeout

- The GitHub updater is real-world validated and frozen.
- v1.6.8 is the final real Store updater E2E target and remains **PENDING**.
- Current documentation is governed by `project-status.json` and completed in Chinese, Japanese, and English.
