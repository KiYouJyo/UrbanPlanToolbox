...
- 修复更新弹窗标题资源键显示异常，并为 Microsoft Store 更新增加真实进度和下载/部署状态反馈。
- GitHub：正式发布 v1.5.2。
- Microsoft Store：提交 v1.5.2 认证；认证完成并确认公开前不表示已公开。
...
- GitHub 最新正式版本：`v1.5.2`。
- Microsoft Store：v1.5.2 提交认证，认证完成并确认公开前不标记为已公开；最后实际公开版本仍以 Partner Center 状态为准。
